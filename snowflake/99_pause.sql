...
-- Couche surveillance ML (07_ml_anomaly.sql)
ALTER TASK  IF EXISTS ANALYTICS.MONITORING.CRYPTO_ANOMALY_RETRAIN    SUSPEND;
ALTER TASK  IF EXISTS ANALYTICS.MONITORING.CRYPTO_ANOMALY_SCORE      SUSPEND;
ALTER ALERT IF EXISTS ANALYTICS.MONITORING.CRYPTO_ANOMALY_ALERT      SUSPEND;
-- Retention RAW (08_raw_retention.sql)
ALTER TASK  IF EXISTS ANALYTICS.MONITORING.CRYPTO_RAW_RETENTION      SUSPEND;
-- DT restante (FCT_OHLCV_1MIN est passe en INCREMENTAL -> ce n'est plus une Dynamic Table)
